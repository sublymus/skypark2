...
import { Controllers, DescriptionSchema, EventPostSchema, EventPreSchema, ModelControllerSchema, ModelControllers, ModelFrom_optionSchema, ModelInstanceSchema, MoreSchema, ResponseSchema } from "./Initialize";
import { FileValidator, backDestroy } from "./ModelCtrlManager";
import Log from "sublymus_logger";

export const createFactory = (controller: ModelControllerSchema, option: ModelFrom_optionSchema & { modelPath: string }, callPost: (e: EventPostSchema) => ResponseSchema, callPre: (e: EventPreSchema) => Promise<void>) => {
    return async (
        ctx: ContextSchema,
        more: MoreSchema
    ): ResponseSchema => {
