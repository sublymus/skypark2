...
import { Controllers, CtrlModelMakerSchema, ModelControllers } from "./Initialize";
...
export class Tools {
    constructor(private ctrlMaker: CtrlModelMakerSchema) {

    }
    assigneToNewListElement(data: assigneToNewListElementSchema) {
        const listenner = async ({ res, ctx }) => {
        ...
        this.ctrlMaker.post('list', listenner);
    }
}
